...
# Failed to retrieve data from API: 404 Client Error: Not Found for url: https://files.rcsb.org/download/9D9C.pdb
    ...
    # os.makedirs(dst_dir, exist_ok=True)
    # write_raw_pdb_or_cif('7ZE0', cif_or_pdb, dst_dir)
    # write_raw_pdb_or_cif('9D9A', cif_or_pdb, dst_dir)
    # write_raw_pdb_or_cif('9D9B', cif_or_pdb, dst_dir)
    # write_raw_pdb_or_cif('9D9C', cif_or_pdb, dst_dir)
