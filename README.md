...
Experiental validation of the utility of DDM, PCA-ED and NMA for protein dynamics:
...
(Some descriptions given for data files as these were not added to git, but can all be generated by running code in `src` dir)

<details open>
<summary style="margin-left: 0.5em;">data/</summary>

<details open>
<summary style="margin-left: 1em;">DynDom/</summary>

<summary style="margin-left: 2em;">2 .html files & 2 .csv files: 2 tables copy-pasted from DynDom webpages & scrapped to 2 .csv files.</summary>
<details>
<summary style="margin-left: 2em;">Hayward_files/</summary>

<details>
<summary style="margin-left: 2.5em;">foldseek/</summary>

<details>
<summary style="margin-left: 3em;">subdirs, 1 per pdb, e.g. 2DN1/</summary>
<details>
<summary style="margin-left: 3.5em;">21 Foldseek-related files: </summary>

<details><summary style="margin-left: 4em;">14 files output by Foldseek's `createdb`:</summary>
...
<details><summary style="margin-left: 4em;">7 other files:</summary>
...
<details open>
<summary style="margin-left: 1em;">NMR/</summary>

<details>
<summary style="margin-left: 1.5em;">datasets/</summary>
<summary style="margin-left: 2.5em;">2713 individual PDB-chains, as .pdb files </summary>
</details>

<details>
<summary style="margin-left: 1.5em;">mmseqs/</summary>
<details>
<summary style="margin-left: 2em;">multimod_2713_hetallchains_hom1chain/</summary>
<details>
<summary style="margin-left: 2.5em;">dir2delete/</summary>
<summary style="margin-left: 3.5em;">temporary/output files generated by MMseqs2 which can be deleted to save memory</summary>
</details>
<details>
<summary style="margin-left: 2.5em;">fasta/</summary>
<summary style="margin-left: 3.5em;">1 big .fasta file: amino acid sequences of all 2713 PDB-chains.</summary>
</details>
<details>
<summary style="margin-left: 2.5em;">results/</summary>
<summary style="margin-left: 3.5em;">1 big .csv file: all-vs-all alignment results (query | target | evalue | pident | alnlen | qcov | tcov)</summary>
</details>
</details>
</details>
<details>
<summary style="margin-left: 1.5em;">multimodel_lists/</summary>
<summary style="margin-left: 2.5em;">4 .txt files: heteromeric & homomeric & single & multimodel pdb-chain ids (1 per line)</summary>
<summary style="margin-left: 2.5em;">2 .lst files: single & multimodel pdb-chain ids (1 per line)</summary>
</details>
<details>
<summary style="margin-left: 1.5em;">parsed_cifs/</summary>
<details>
<summary style="margin-left: 2.5em;">multimod_2713_hetallchains_hom1chain/</summary>
<summary style="margin-left: 3.5em;">2713 .ssv files</summary>
</details>
</details>

<details>
<summary style="margin-left: 1.5em;">pdb_chains/</summary>
<details>
<summary style="margin-left: 2.5em;">multimod_2713_hetallchains_hom1chain/</summary>
<summary style="margin-left: 3.5em;">2713 .pdb files: for each of 2713 pdb-chains (processed from 2713 mmCIFs, via Biopython).</summary>
<details>
<summary style="margin-left: 3.5em;">mean_coords/</summary>
<summary style="margin-left: 4.5em;">2713 .pdb files: mean of models coords, per pdb-chain.</summary>

<details>
<summary style="margin-left: 3.5em;">per_model/</summary>
<summary style="margin-left: 4.5em;">(2713 subdirs, 1 dir per pdb-chain)/</summary>
...
<details>
<summary style="margin-left: 1.5em;">prot_dynamics/</summary>
<summary style="margin-left: 2.5em;">52 .lst files (i.e. just trying it out with 52 pdb-chains): <= 20 RMSD scores for model pairs with highest scores, per pdb-chain.</summary>
</details>

<details>
<summary style="margin-left: 1.5em;">raw_cifs/</summary>
<details><summary style="margin-left: 2.5em;">heteromeric/</summary>
<summary style="margin-left: 3.5em;">1038 .cif files: 1 mmCIF per protein (all chains).</summary>
</details>
<details><summary style="margin-left: 2.5em;">homomeric/</summary>
<summary style="margin-left: 3.5em;">686 .cif files: 1 mmCIF per protein (all chains).</summary>
</details>
</details>
<details>
<summary style="margin-left: 1.5em;">raw_pdbs/</summary>
<details><summary style="margin-left: 2.5em;">heteromeric/</summary>
<summary style="margin-left: 3.5em;">1038 .pdb files: 1 PDB per protein (all chains).</summary>
</details>
<details><summary style="margin-left: 2.5em;">homomeric/</summary>
<summary style="margin-left: 3.5em;">686 .pdb files: 1 PDB per protein (all chains).</summary>
</details>
</details>

<details>
<summary style="margin-left: 1.5em;">RMSD/</summary>

<details>
<summary style="margin-left: 2.5em;">multimod_2713_hetallchains_hom1chain/</summary>
<summary style="margin-left: 3.5em;">2713 .csv files: RMSD scores of mean of models vs each model, for each of 2713 pdb-chains.</summary>

<details>
<summary style="margin-left: 3.5em;">mean_coords/</summary>
<summary style="margin-left: 4.5em;">2713 .csv files: mean of models coords, for each of 2713 pdb-chains.(pre-calculated for use in calc of RMSD for mean vs each model, saved to .csv files in dir level above)</summary>
</details>

<details>
<summary style="margin-left: 3.5em;">rmsd_matrices/</summary>
<summary style="margin-left: 4.5em;">2713 .npz files: RMSD scores of all-vs-all models, for each of 2713 pdb-chains.</summary>
</details>
...
<details>
<summary style="margin-left: 1.5em;">stats/</summary>

<details>
<summary style="margin-left: 2.5em;">multimod_2713_hetallchains_hom1chain</summary>
<summary style="margin-left: 3.5em;">1 .csv file: 1541 pdb-ids | head | all chains | heteromeric/homomeric | year | number of models</summary>
<summary style="margin-left: 3.5em;">> 5 .csv/.lst files: various other stats</summary>

</details>
</details>

<details>
<summary style="margin-left: 1.5em;">TMscores/</summary>
<details>
<summary style="margin-left: 2.5em;">multimod_2713_hetallchains_hom1chain/</summary>
<summary style="margin-left: 3.5em;">2702 .csv files: 2702 TM-scores for each model vs mean coords per pdb-chain. (11 of 2713 too short for TM-align)</summary>
<details>
<summary style="margin-left: 3.5em;">tms_matrices/</summary>
...
<details open>
<summary style="margin-left: 1em;">XRAY/</summary>
<details>
<summary style="margin-left: 1.5em;">handpicked/</summary>
<details><summary style="margin-left: 2em;">haemoglobin/</summary>
<details><summary style="margin-left: 2.5em;">deoxy/</summary>
<summary style="margin-left: 3.5em;">2 files: 2DN2.cif & 2DN2.pdb</summary>
</details>
<details><summary style="margin-left: 2.5em;">oxy/</summary>
<summary style="margin-left: 3.5em;">2 files: 2DN1.cif & 2DN1.pdb</summary>
</details>
...
<summary style="margin-left: 1.5em;">DynDom_reader.py</summary>  
<summary style="margin-left: 1.5em;">essential_dynamics.py</summary>  
<summary style="margin-left: 1.5em;">foldseek.py</summary>  
<summary style="margin-left: 1.5em;">mmseqs2.py</summary>  
<summary style="margin-left: 1.5em;">nmr_dataset.py</summary>  
<summary style="margin-left: 1.5em;">pdb_model_stats.py</summary>  
<summary style="margin-left: 1.5em;">plotter.py</summary>  
<summary style="margin-left: 1.5em;">RMSD.py</summary>  
<summary style="margin-left: 1.5em;">tm_aligner.py</summary>  
<details>
<summary style="margin-left: 1.5em;">TMalign_exe</summary>
<details>
<summary style="margin-left: 2em;">Darwin</summary>
<summary style="margin-left: 3em;">3 files: TMalign binary (executable), TMalign.cpp, TMalign.h</summary>
</details>
<details>
<summary style="margin-left: 2em;">Linux</summary>
<summary style="margin-left: 3em;">1 file: TMalign.cpp (view from Mac, i.e. not compiled.)</summary>
</details>
</details>
<details>
<summary style="margin-left: 1.5em;">unused_dataset_prune_and_versioning/</summary>
<summary style="margin-left: 2.5em;">Dataset_version_specifications.md</summary>
<summary style="margin-left: 2.5em;">prune_dataset.py</summary>
</details>

<details>
<summary style="margin-left: 1.5em;">unused_DL_model_training/</summary>
<summary style="margin-left: 2.5em;">(Some autogenerated config dirs & files.)</summary>
</details>

<details>
<summary style="margin-left: 1.5em;">unused_MD_scripts/</summary>
<summary style="margin-left: 2.5em;">atlas.py</summary>
<summary style="margin-left: 2.5em;">bulk_download_whole_atlas.py</summary>
<summary style="margin-left: 2.5em;">mdCATH.py</summary>
