...
- <details><summary><strong>src/</strong></summary><br>
  ...
  - <details><summary><strong>Essential dynamics (ED):</strong></summary><br>
    ...
    much an ensemble fluctuates along that mode; and the corresponding eigenvector(s) (of shape 3N, where N is the 
    number of atoms)), each of which tells you the actual pattern of motion in terms of which atoms move where when the 
    protein moves along that mode. Scores generated by projecting each model to the eigenvectors indicates how much 
